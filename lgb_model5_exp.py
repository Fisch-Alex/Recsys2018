...
from Generate_features_scenario5 import Generate_features_scenario5 as Generate_features
...
class LGB_Model5:
	...
	def fit(self,playlist_info,playlists,track_info_dict,num_boost_round,early_stopping_rounds,number_of_samples,FPs,num_seed_track = 10,verbose_eval=1,tuning=True,test_size=0.2,seed=134):
	...
	def predict(self,playlist_info,test_playlists,playlists,track_info_dict):
		...
		def predict_one(ii):
			...
			X_test  = Generate_features(testdata,info,playlists,track_info_dict,self.list_to_try,self.CV_list_of_common_albums,self.CV_list_of_common_artists)
