...
class LGB_Model10:
	...
	def fit(self,playlist_info,playlists,track_info_dict,num_boost_round,early_stopping_rounds,number_of_samples,FPs,num_seed_track = 100,verbose_eval=1,tuning=True,test_size=0.2,seed=114):
