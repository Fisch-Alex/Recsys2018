...
from Generate_features_scenario2 import Generate_features_scenario2 as Generate_features
...
class LGB_Model2:
	...
	def fit(self,playlist_info,playlists,track_info_dict,num_boost_round,early_stopping_rounds,number_of_samples,FPs,num_seed_track = 5,verbose_eval=20,tuning=True,test_size=0.2,seed=134):
